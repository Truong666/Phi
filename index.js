const contentLetterSrart_actived = "Hello pà, tui có cái này cho pà nè." //Lời mở đầu cho bức thư
const mainContentLetter = "Happy Birthdayyy, chúc pà ngày càng đẹp gái, luôn vui vẻ và hạnh phúc. Đặc biệt là đỗ nguyện vọng 1 nhaaa." //Nội dung của bức thư
